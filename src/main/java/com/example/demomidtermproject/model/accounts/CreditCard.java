...
public class CreditCard extends Account {
    ...
    @DecimalMin(value = "0.1", message = "Credit card's interest rate must be avobe 0.1")
    @Column(precision = 32, scale = 4)
    private BigDecimal interestRate;

    @DecimalMin(value = "100", message = "Credit card's limit must be above 100")
    @DecimalMax(value = "100000", message = "Credit card's limit must be below 100000")
